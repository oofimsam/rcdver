...
class CreateGroupRanksCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['rcdvercreategroupranks'],
  ...
  async fn (msg, args) {
    try {
      ...
      msg.reply(`:no_entry_sign: Something went wrong. Maybe the group doesn't exist, or maybe RCDVer doesn't have permission to create roles in this server.`)
    }
  }
}
