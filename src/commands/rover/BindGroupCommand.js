...
class BindGroupCommand extends Command {
  constructor (client) {
    super(client, {
      name: 'bindrank',
      properName: 'BindRank',
      aliases: ['rcdverbindgrouprank', 'bindgroup', 'bindgrouprank', 'rcdverbind', 'bind'],
