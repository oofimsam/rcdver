...
class CreateVerifyChannelCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['rcdvercreateverifychannel', 'createverify', 'createverificationchannel', 'createverification', 'createverifychannels'],
  ...
  async fn (msg) {
    try {
      ...
      msg.reply(`:no_entry_sign: RCDVer does not have permission to create channels in this server.`)
    }
  }
}
